    ...
    return modules = [ function(module) {
        ...
        function determineTestTemplate(pos, tests) {
            ...
            for (var altTest = getTest.call(this, pos), targetLocator = getLocator(altTest), tstLocator, closest, bestMatch, ndx = 0; ndx < tests.length; ndx++) {
                ...
                (void 0 === closest || "" !== tstLocator && distance < closest || bestMatch && !opts.greedy && bestMatch.match.optionality && "layouts" === bestMatch.match.newBlockMarker && (!tst.match.optionality || !tst.match.newBlockMarker) || bestMatch && bestMatch.match.optionalQuantifier && !tst.match.optionalQuantifier) && (closest = distance,
                bestMatch = tst);
            }
            return bestMatch;
        }
        ...
        function trackbackPositions(originalPos, newPos, fillOnly) {
            ...
            for (var ps = originalPos; ps < newPos; ps++) if (void 0 === maskset.validPositions[ps] && !_positioning.isMask.call(this, ps, !0)) {
                ...
                if (vp) {
                    ...
                    if (bestMatch && (!0 !== bestMatch.match.jit || "layouts" === bestMatch.match.newBlockMarker && (np = maskset.validPositions[ps + 1]) && !0 === np.match.optionalQuantifier) && (bestMatch = $.extend({}, bestMatch, {
        ...
        function analyseMask(mask, regexMask, opts) {
            ...
            function insertTestDefinition(mtoken, element, position) {
                ...
                if (regexMask) 0 === element.indexOf("[") || escaped && /\\d|\\s|\\w]/i.test(element) || "." === element ? mtoken.matches.splice(position++, 0, {
                    ...
                    static: !1,
                    optionality: !1,
                    newBlockMarker: void 0 === prevMatch ? "layouts" : prevMatch.def !== element,
                    casing: null,
                    def: element,
                    placeholder: void 0,
                    nativeDef: element
                    ...
                    prevMatch = mtoken.matches[position - 1], mtoken.matches.splice(position++, 0, {
                        ...
                        static: !0,
                        optionality: !1,
                        newBlockMarker: void 0 === prevMatch ? "layouts" : prevMatch.def !== lmnt && !0 !== prevMatch.static,
                        casing: null,
                    ...
                    maskdef && !escaped ? mtoken.matches.splice(position++, 0, {
                        ...
                        optionality: !1,
                        newBlockMarker: void 0 === prevMatch ? "layouts" : prevMatch.def !== (maskdef.definitionSymbol || element),
                        ...
                        static: !0,
                        optionality: !1,
                        newBlockMarker: void 0 === prevMatch ? "layouts" : prevMatch.def !== element && !0 !== prevMatch.static,
                        casing: null,
